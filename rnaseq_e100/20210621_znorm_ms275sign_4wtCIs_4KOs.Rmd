...
# png(filename = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/quality_check.png", width = 800, height = 600)
...
for (listname in out_lists) {
  write_xlsx(rownames_to_column(as.data.frame(get(listname)), "gene_id"),
           path = paste0("20210621_znorm_ms275sign_4wtCIs_4KOs_report/MS275_", listname, ".xlsx"))
}
...
write_xlsx(usefull_ratios, path = paste0("20210621_znorm_ms275sign_4wtCIs_4KOs_report/MS275_ratios.xlsx"))
all_ratios = column_to_rownames(all_ratios, "comparison")

gene_numbers = data.frame(out_lists, out_lists_counts)
write_xlsx(gene_numbers, path = paste0("20210621_znorm_ms275sign_4wtCIs_4KOs_report/MS275_GeneCounts.xlsx"))
...
# test for z score data
```{r znorm_test}
vsd <- vst(dds, blind=FALSE)
vsd_sig <- vsd[!(row.names(vsd) %in% setdiff(rownames(vsd), rownames(ms275_vs_ctrl_up))), ]
vsd_sig <- vsd_sig[match(rownames(ms275_vs_ctrl_up), row.names(vsd_sig)),]
attr(assay(vsd_sig, withDimnames=FALSE), "dimnames") <- list(ms275_vs_ctrl_up$gene_name)
select <- order(ms275_vs_ctrl_up$log2FoldChange, decreasing=TRUE)[1:120]
mat <- assay(vsd_sig, withDimnames=FALSE)[select,]
thr <- 24 
colramp <- seq(from=-thr, to=thr, length=101)
mat[mat < -thr] <- -thr
mat[mat > thr] <- thr
pheatmap(mat, breaks = colramp, cluster_rows=TRUE, show_rownames=TRUE, cluster_cols=FALSE, fontsize_col = 15, angle_col = 90, cellheight = 12, clustering_method = "ward.D2", cellwidth = 50, legend = TRUE, fontsize = 10, fontsize_row = 10, filename = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up_test.pdf", cutree_rows = 5)

```


# Test of Heatmap function to compare to code for znorm
```{r_heatmap_function_test}
 betas <- coef(dds)

  betas_sig <- betas[!(row.names(betas) %in% setdiff(rownames(betas), rownames(ms275_vs_ctrl_up))), ]
  betas_sig <- betas_sig[match(rownames(ms275_vs_ctrl_up), row.names(betas_sig)),]


  betascols <- c("intercept", "HDAC1wt HDAC1Mut", "HDAC2wt HDAC2Mut", "HDAC3wt HDAC3Mut", "HDAC8wt HDAC8Mut",
                "HDAC1KO", "HDAC2KO", "HDAC3KO", "HDAC8KO", "MS275")
  attr(betas_sig, "dimnames") <- list(ms275_vs_ctrl_up$gene_name)
  
  topGenes <- head(order(ms275_vs_ctrl_up$log2FoldChange, decreasing = TRUE), 120)
  mat <- betas_sig[topGenes, -1]
...
pheatmap(mat, breaks = colramp, cluster_col = FALSE,
                         cluster_rows = TRUE,
           fontsize_col = 15, angle_col = 90, main = "title", display_numbers = FALSE,
           cellheight = 12, clustering_method = "ward.D2",
           cellwidth = 50, legend = TRUE, fontsize = 10, fontsize_row = 10,
           filename = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/heatmap_test.pdf", cutree_rows = 5)
```
...
res_table_full <- create_heatmap_complete(ms275_vs_ctrl_up, 4000, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up.pdf")
gene_list <- res_table_full$tree_row$labels[c(res_table_full$tree_row$order)]
write_xlsx(as.data.frame(gene_list),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up.pdf")
...
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_upkmeans.xlsx)

### complete heatmap kmeans clustering
```{r gene_heatmap_up_kmeans, out.height = "600px", out.width = "100%"}
res_table_full <- create_heatmap_kmeans_complete(ms275_vs_ctrl_up, 4000, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up_kmeans.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table_full), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up_kmeans.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up_kmeans.pdf")
message("genes: ", length(rownames(res_table_full)))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_up",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_up_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up_kmeans.xlsx)

### complete heatmap ranked
```{r gene_heatmap_upr, out.height = "600px", out.width = "100%"}
res_table_full <- create_heatmap_complete(ms275_vs_ctrl_up, 4000, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_upr.pdf",
                            clustered = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table_full), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_upr.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_upr.pdf")
message("genes: ", length(rownames(res_table_full)))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_up",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_up_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_upr.xlsx)


### top120 clustered
```{r gene_heatmap_up120, out.width = "60%"}
res_table <- create_heatmap(ms275_vs_ctrl_up, 120, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120.png")
gene_list <- res_table$tree_row$labels[c(res_table$tree_row$order)]
write_xlsx(as.data.frame(gene_list),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_up120.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120.png")
message("genes: ", length(res_table$tree_row$labels))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_up",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_up_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120.xlsx)

### top120 kmeans
```{r gene_heatmap_up120_kmeans, out.width = "60%"}
res_table <- create_heatmap_kmeans(ms275_vs_ctrl_up, 120, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120_kmeans.png")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120_kmeans.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120_kmeans.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_up",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_up_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120_kmeans.xlsx)

### top120 ranked
```{r gene_heatmap_up120r, out.width = "60%"}
res_table <- create_heatmap(ms275_vs_ctrl_up, 120, "Upregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120r.png",
                            clustered = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120r.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120r.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_up",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_up_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_up/ms275_up120r.xlsx)
...
out_file <- file("20210621_znorm_ms275sign_4wtCIs_4KOs_report/numbers_ms275_up.txt", "w")
...
close(out_file)
readLines("20210621_znorm_ms275sign_4wtCIs_4KOs_report/numbers_ms275_up.txt")
```
...
res_table_full <- create_heatmap_complete(ms275_vs_ctrl_down, 4000, "downregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down.pdf", sort_decr = FALSE)
gene_list <- res_table_full$tree_row$labels[c(res_table_full$tree_row$order)]
write_xlsx(as.data.frame(gene_list),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down.pdf")
...
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down.xlsx)

### complete heatmap kmeans clustering
```{r gene_heatmap_down_kmeans, out.height = "600px", out.width = "100%"}
res_table_full <- create_heatmap_kmeans_complete(ms275_vs_ctrl_down, 4000, "downregulated downon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down_kmeans.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table_full), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down_kmeans.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down_kmeans.pdf")
message("genes: ", length(rownames(res_table_full)))
message("Total downregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_down",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_down_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down_kmeans.xlsx)

### complete heatmap ranked
```{r gene_heatmap_downr, out.height = "600px", out.width = "100%"}
res_table_full <- create_heatmap_complete(ms275_vs_ctrl_down, 4000, "downregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_downr.pdf",
                            clustered = FALSE, sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table_full), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_downr.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_downr.pdf")
message("genes: ", length(rownames(res_table_full)))
message("Total downregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_down",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_down_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_downr.xlsx)

### top120 clustered
```{r gene_heatmap_down120, out.width = "60%"}
res_table <- create_heatmap(ms275_vs_ctrl_down, 120, "downregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120.png", sort_decr = FALSE)
gene_list <- res_table$tree_row$labels[c(res_table$tree_row$order)]
write_xlsx(as.data.frame(gene_list),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120.png")
message("genes: ", length(res_table$tree_row$order))
message("Total downregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_down",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_down_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120.xlsx)

### top120 kmeans
```{r gene_heatmap_down120_kmeans, out.width = "60%"}
res_table <- create_heatmap_kmeans(ms275_vs_ctrl_down, 120, "downregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120_kmeans.png", clustered = FALSE, sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120_kmeans.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120_kmeans.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_down",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_down_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120_kmeans.xlsx)

### top120 ranked
```{r gene_heatmap_down120r, out.width = "60%"}
res_table <- create_heatmap(ms275_vs_ctrl_down, 120, "downregulated upon MS275 treatment", "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120r.png",
                            clustered = FALSE, sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120r.xlsx")
include_graphics("20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120r.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in MS275 treatment: ", gene_numbers["ms275_vs_ctrl_down",])
message("percentage from all deregulated genes: ", all_ratios["ms275_vs_ctrl_down_from_ms275_vs_ctrl_all",],"%")
```
[download Excel Table](20210621_znorm_ms275sign_4wtCIs_4KOs_report/ms275_down/ms275_down120r.xlsx)
...
#write to file and output in notebook
out_file <- file("20210621_znorm_ms275sign_4wtCIs_4KOs_report/numbers_ms275_down.txt", "w")
...
close(out_file)
readLines("20210621_znorm_ms275sign_4wtCIs_4KOs_report/numbers_ms275_down.txt")
```
