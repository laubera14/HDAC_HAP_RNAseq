...
```{r data_import}
ms275_3uM_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_MS275_3uM_24h_vs_wt_native_down.csv")
ms275_1uM_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_MS275_1uM_24h_vs_wt_native_down.csv")
jq12_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_JQ12_1uM_24h_vs_wt_native_down.csv")
hdac1_141_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_inactive_HDAC1_vs_wt_native_down.csv")
hdac2_142_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_inactive_HDAC2_vs_wt_native_down.csv")
hdac3_135_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_inactive_HDAC3_vs_wt_native_down.csv")
hdac8_143_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_inactive_HDAC8_vs_wt_native_down.csv")
hdac1_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC1ko_native_vs_wt_native_down.csv")
hdac2_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC2ko_native_vs_wt_native_down.csv")
hdac3_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC3ko_native_vs_wt_native_down.csv")
hdac8_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC8ko_native_vs_wt_native_down.csv")
```
...
ms275_1uM_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_MS275_1uM_24h_vs_wt_native_down.csv")
jq12_in <- read_csv("20210318_inhibitor_all/symb_list/group_wt_JQ12_1uM_24h_vs_wt_native_down.csv")
hdac1_ko_141_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC1ko_inactive_vs_wt_native_down.csv")
hdac2_ko_142_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC2ko_inactive_vs_wt_native_down.csv")
hdac3_ko_135_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC3ko_inactive_vs_wt_native_down.csv")
hdac8_ko_143_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC8ko_inactive_vs_wt_native_down.csv")
hdac1_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC1ko_native_vs_wt_native_down.csv")
hdac2_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC2ko_native_vs_wt_native_down.csv")
hdac3_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC3ko_native_vs_wt_native_down.csv")
hdac8_ko_in <- read_csv("20210318_inhibitor_all/symb_list/group_HDAC8ko_native_vs_wt_native_down.csv")
...
png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_wt_odds_down.png", width = 1000, height = 800)
drawHeatmap(gom.obj, what = "odds.ratio", grid.col = "Blues", note.col = "black", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()


png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_ko_odds_down.png", width = 1000, height = 800)
drawHeatmap(gom.obj.ko, what = "odds.ratio", grid.col = "Blues", note.col = "black", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()



png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_wt_jaccard_down.png", width = 1000, height = 800)
drawHeatmap(gom.obj, what = "Jaccard", grid.col = "Blues", note.col = "black", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()


png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_ko_jaccard_down.png", width = 1000, height = 800)
...
png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_wt_odds_down_nopvalue.png", width = 1000, height = 800)
drawHeatmap(gom.obj, what = "odds.ratio", grid.col = "Blues", note.col = "transparent", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()


png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_ko_odds_down_nopvalue.png", width = 1000, height = 800)
drawHeatmap(gom.obj.ko, what = "odds.ratio", grid.col = "Blues", note.col = "transparent", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()



png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_wt_jaccard_down_nopvalue.png", width = 1000, height = 800)
drawHeatmap(gom.obj, what = "Jaccard", grid.col = "Blues", note.col = "transparent", adj.p = TRUE, log.scale = TRUE, cutoff = 0.001)
dev.off()


png("20210318_inhibitor_all/list_overlaps/geneOverlapMatrix_ko_jaccard_down_nopvalue.png", width = 1000, height = 800)
...
write(hdac1_hdac8_list, file = "20210318_inhibitor_all/overlap_list/hdac1KO_hdac8KO_common_down.txt")
write(hdac1_hdac8_143_list, file = "20210318_inhibitor_all/overlap_list/hdac1KO_hdac8KO_143_common_down.txt")
...
write_tsv(hdac1_ko_hdac8_ko_comb_hdac1, file = "20210318_inhibitor_all/overlap_list/HDAC1KO_HDAC8KO_common_down_log2Foldchanges_HDAC1.tsv")

hdac1_ko_hdac8_ko_comb_hdac8 <- inner_join(tibble_hdac1_ko_hdac8_ko, tibble_hdac8_ko_full)
write_tsv(hdac1_ko_hdac8_ko_comb_hdac8, file = "20210318_inhibitor_all/overlap_list/HDAC1KO_HDAC8KO_common_down_log2Foldchanges_HDAC8.tsv")
...
write_tsv(hdac1_ko_hdac8_ko_143_comb_hdac1, file = "20210318_inhibitor_all/overlap_list/HDAC1KO_HDAC8KO_143_common_down_log2Foldchanges_HDAC1.tsv")

hdac1_ko_hdac8_ko_143_comb_hdac8 <- inner_join(tibble_hdac1_ko_hdac8_ko_143, tibble_hdac8_ko_143_full)
write_tsv(hdac1_ko_hdac8_ko_143_comb_hdac8, file = "20210318_inhibitor_all/overlap_list/HDAC1KO_HDAC8KO_143_common_down_log2Foldchanges_HDAC8.tsv")
```
