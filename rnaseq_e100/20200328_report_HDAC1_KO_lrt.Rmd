---
title: 'HAP FFG RNA-seq: LRT-version of HDAC1 Heatmaps KO rel. ctrl and dynamic deregulation after
...
create_heatmap <- function(inp_list, n_genes, title, out_file, sort_decr = TRUE, clustered = TRUE, numbers = FALSE) {
  ...
  betascols <- c("intercept", "HDAC1KO HDAC1wt vs ctrl", "HDAC1KO HDAC1Mut vs ctrl", "HDAC1KO vs ctrl", "HDAC1KO HDAC1wt",
                 "HDAC1KO HDAC1Mut")
  ...
  col.order <- c("HDAC1KO vs ctrl", "HDAC1KO HDAC1wt", "HDAC1KO HDAC1Mut")
  mat <- mat[,col.order]
...
cts <- cts_full %>% select(gene_id, contains(c("HAP_1_", "HAP_2_", "HAP_3_", "HD1"))) %>% column_to_rownames("gene_id")
...
coldata$group <- factor(coldata$group, levels = c("wt_native", "HDAC1ko_native", "HDAC1ko_inactive", "HDAC1ko_active"))
```
...
Sort the genes which are upregulated by reintroduction of wt HDAC1 into a downregulated set and an upregulated set. therefore the log2foldChanges have to be read by extracting the corresponding contrast from the dds object. Gene names have to be added first to the results table, before it is made smaller.
```{r active_reintro_KO_up}
KOca_vs_KO_all <- results(dds, contrast = c("group", "HDAC1ko_active", "HDAC1ko_native"))
...
Same as above, but this time for the genes which are downregulated in KO. The gene sets, which describe the upregulated or downregulated genes upon wt HDAC1 reintroduction were defined in the previous section.
...
This if for the genes which are not affected by the KO, but are regulated by the reintroduction of the wt HDAC1
...
* Reintroduction of the catalytically inactive HDAC1 Mutant
...
```{r inactive_reintro}
KOci_vs_KO_all <- results(dds, contrast = c("group", "HDAC1ko_inactive", "HDAC1ko_native"))
...
* Grouping can be started:
  ...
  + i) When both active and inactive HDAC1 do the same.
```{r i_same}
...
```
  ...
  + ii) When the catalytically inactive HDAC1 doesn't affect gene regulation
```{r ii_no_change}
...
```
  ...
  + iii) dominant negative effect upon reintroduction of the catalytically inactive HDAC1
...
```
  ...
  + iv) What if HDAC1 KO doesn't affect the gene, but introduction of the catalytically inactive HDAC1 causes deregulation?
...
for (listname in out_lists) {
  write_xlsx(rownames_to_column(as.data.frame(get(listname)), "gene_id"),
           path = paste0("20210328_LRT_HDACko_HDACreintroduction_e100_report/HDAC1_", listname, ".xlsx"))
}
...
write_xlsx(usefull_ratios, path = paste0("20210328_LRT_HDACko_HDACreintroduction_e100_report/HDAC1_ratios.xlsx"))
all_ratios = column_to_rownames(all_ratios, "comparison")

gene_numbers = data.frame(out_lists, out_lists_counts)
write_xlsx(gene_numbers, path = paste0("20210328_LRT_HDACko_HDACreintroduction_e100_report/HDAC1_GeneCounts.xlsx"))
...
## i) Active and inactive HDAC1 do the same
### complete Heatmap
```{r gene_heatmap_same_up, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap(KO_up_KOca_down_KOci_down_vs_ctrl, 10000, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same.pdf")
...
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same.xlsx)

```{r gene_heatmap_same_down, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap(KO_down_KOca_up_KOci_up_vs_ctrl, 10000, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same.pdf")
message("genes: ", length(rownames(res_table)))
...
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same.xlsx)

### Top30 with numbers
```{r gene_heatmap_same_up30n, out.width = "50%"}
res_table <- create_heatmap(KO_up_KOca_down_KOci_down_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30n.png", numbers = TRUE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30n.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_down_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_up_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30n.png", numbers = TRUE,
               clustered = FALSE, sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30n.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_up_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_down_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_down_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_up_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30.png", sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_up_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_down_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30rank.png", clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_same30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_down_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_up_vs_ctrl, 30, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30rank.png", sort_decr = FALSE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_same30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_up_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
## ii) Catalytically inactive HDAC1 doesn't affect gene regulation
### complete Heatmap
```{r gene_heatmap_unch_up, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap(KO_up_KOca_down_KOci_unch_vs_ctrl, 10000,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch.pdf")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_unch_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch.xlsx)

```{r gene_heatmap_unch_down, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap(KO_down_KOca_up_KOci_unch_vs_ctrl, 10000,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch.pdf")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_unch_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch.xlsx)

### Top30 with numbers
```{r gene_heatmap_unch_up30n, out.width = "50%"}
res_table <- create_heatmap(KO_up_KOca_down_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30n.png", numbers = TRUE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30n.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_unch_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30n.png", numbers = TRUE,
               clustered = FALSE, sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30n.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_unch_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_unch_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30.png", sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_unch_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30rank.png", clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_unch30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_unch_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_unch_vs_ctrl, 30,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30rank.png", sort_decr = FALSE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_unch30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_unch_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_up_vs_ctrl, 10000, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.pdf")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_up_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.xlsx)
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_down_vs_ctrl, 10000, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.pdf")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_down_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.xlsx)
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_up_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30n.png", numbers = TRUE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30n.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_up_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_down_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30n.png", numbers = TRUE,
               clustered = FALSE, sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30n.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_down_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_up_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_up_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_down_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30.png",
               sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_down_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_up_KOca_down_KOci_up_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30rank.png",
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
message("percentage from upregulated genes in KO: ", all_ratios["KO_up_KOca_down_KOci_up_vs_ctrl_from_KO_vs_ctrl_up",],"%")
```
...
res_table <- create_heatmap(KO_down_KOca_up_KOci_down_vs_ctrl, 30, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30rank.png",
               sort_decr = FALSE, clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
message("percentage from downregulated genes in KO: ", all_ratios["KO_down_KOca_up_KOci_down_vs_ctrl_from_KO_vs_ctrl_down",],"%")
```
...
res_table <- create_heatmap(KO_unchup_KOci_up_vs_KO, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO.pdf")
message("genes: ", length(rownames(res_table)))
...
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO.xlsx)
...
res_table <- create_heatmap(KO_unchdown_KOci_down_vs_KO, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO.pdf")
message("genes: ", length(rownames(res_table)))
...
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO.xlsx)
...
res_table <- create_heatmap(KO_unchup_KOci_up_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30n.png",
               numbers = TRUE, clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30n.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or upregulated in KO: ", gene_numbers["KO_vs_ctrl_unchup",])
message("percentage from unchanged or upregulated genes in KO: ", all_ratios["KO_unchup_KOci_up_vs_KO_from_KO_vs_ctrl_unchup",],"%")
```
...
res_table <- create_heatmap(KO_unchdown_KOci_down_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30n.png", sort_decr = FALSE, numbers = TRUE, clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30n.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or downregulated in KO: ", gene_numbers["KO_vs_ctrl_unchdown",])
message("percentage from unchanged or downregulated genes in KO: ",
        all_ratios["KO_unchdown_KOci_down_vs_KO_from_KO_vs_ctrl_unchdown",],"%")
...
res_table <- create_heatmap(KO_unchup_KOci_up_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or upregulated in KO: ", gene_numbers["KO_vs_ctrl_unchup",])
message("percentage from unchanged or upregulated genes in KO: ", all_ratios["KO_unchup_KOci_up_vs_KO_from_KO_vs_ctrl_unchup",],"%")
```
...
res_table <- create_heatmap(KO_unchdown_KOci_down_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30.png", sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or downregulated in KO: ", gene_numbers["KO_vs_ctrl_unchdown",])
message("percentage from unchanged or downregulated genes in KO: ",
        all_ratios["KO_unchdown_KOci_down_vs_KO_from_KO_vs_ctrl_unchdown",],"%")
...
res_table <- create_heatmap(KO_unchup_KOci_up_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30rank.png", clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchup_KOci_up_vs_KO30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or upregulated in KO: ", gene_numbers["KO_vs_ctrl_unchup",])
message("percentage from unchanged or upregulated genes in KO: ", all_ratios["KO_unchup_KOci_up_vs_KO_from_KO_vs_ctrl_unchup",],"%")
```
...
res_table <- create_heatmap(KO_unchdown_KOci_down_vs_KO, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30rank.png", sort_decr = FALSE, clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KO_unchdown_KOci_down_vs_KO30rank.png")
message("genes: ", length(rownames(res_table)))
message("Total unchanged or downregulated in KO: ", gene_numbers["KO_vs_ctrl_unchdown",])
message("percentage from unchanged or downregulated genes in KO: ",
        all_ratios["KO_unchdown_KOci_down_vs_KO_from_KO_vs_ctrl_unchdown",],"%")
...
res_table <- create_heatmap(KOci_vs_KO_up, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.pdf")
message("genes: ", length(rownames(res_table)))
#message("Total upregulated in KO: ", gene_numbers["KO_vs_ctrl_up",])
#message("percentage from upregulated genes in KO: ", all_ratios["KOci_vs_KO_up_from_KO_vs_ctrl_up",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.pdf")
message("genes: ", length(rownames(res_table)))
#message("Total downregulated in KO: ", gene_numbers["KO_vs_ctrl_down",])
#message("percentage from downregulated genes in KO: ", all_ratios["KOci_vs_KO_down_from_KO_vs_ctrl_down",],"%")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)

### Top30 with numbers
```{r gene_heatmap_KOci_vs_KO_up30n, out.width = "50%"}
res_table <- create_heatmap(KOci_vs_KO_up, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30n.png", numbers = TRUE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30n.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30n.png", numbers = TRUE,
               clustered = FALSE, sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30n.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_up, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30.png",
               sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_up, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30rank.png", clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up30rank.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 30, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30rank.png",
               sort_decr = FALSE, clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down30rank.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_up, 60, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up60n.png", numbers = TRUE,
               clustered = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up60n.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 60, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down60n.png", numbers = TRUE,
               clustered = FALSE, sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down60n.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_up, 60, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up60.png")

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up60.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap(KOci_vs_KO_down, 60, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down60.png",
               sort_decr = FALSE)

include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down60.png")
message("genes: ", length(rownames(res_table)))
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated/HDAC1_KOci_vs_KO_down.xlsx)
...
## i) Active and inactive HDAC1 do the same (with MS275 & JQ12)
### complete Heatmap
```{r gene_heatmap_same_up_inh, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap_inh(KO_up_KOca_down_KOci_down_vs_ctrl, 10000, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_same.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_same.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_same.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_same.xlsx)

```{r gene_heatmap_same_down_inh, out.height = "600px", out.width = "100%"}
res_table <- create_heatmap_inh(KO_down_KOca_up_KOci_up_vs_ctrl, 10000, "active and inactive HDAC1 \n do the same",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_same.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_same.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_same.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_same.xlsx)


## ii) Catalytically inactive HDAC1 doesn't affect gene regulation (with MS275 & JQ12)
### complete Heatmap
...
res_table <- create_heatmap_inh(KO_up_KOca_down_KOci_unch_vs_ctrl, 10000,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_unch.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_unch.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_unch.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_unch.xlsx)
...
res_table <- create_heatmap_inh(KO_down_KOca_up_KOci_unch_vs_ctrl, 10000,
                            "catalytically inactive \n HDAC1 doesn't affect \n gene regulation",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_unch.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_unch.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_unch.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_unch.xlsx)
...
res_table <- create_heatmap_inh(KO_up_KOca_down_KOci_up_vs_ctrl, 10000, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_up_with_inh/downregulated_by_wt/HDAC1_KO_up_ci_dominantNegative.xlsx)
...
res_table <- create_heatmap_inh(KO_down_KOca_up_KOci_down_vs_ctrl, 10000, "dominant negative effect",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/KO_down_with_inh/upregulated_by_wt/HDAC1_KO_down_ci_dominantNegative.xlsx)
...
res_table <- create_heatmap_inh(KO_unchup_KOci_up_vs_KO, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchup_KOci_up_vs_KO.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchup_KOci_up_vs_KO.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchup_KOci_up_vs_KO.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchup_KOci_up_vs_KO.xlsx)
...
res_table <- create_heatmap_inh(KO_unchdown_KOci_down_vs_KO, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchdown_KOci_down_vs_KO.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchdown_KOci_down_vs_KO.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchdown_KOci_down_vs_KO.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KO_unchdown_KOci_down_vs_KO.xlsx)
...
res_table <- create_heatmap_inh(KOci_vs_KO_up, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_up.pdf")
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_up.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_up.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_up.xlsx)
...
res_table <- create_heatmap_inh(KOci_vs_KO_down, 10000, "Deregulation by ci intro",
               "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_down.pdf", sort_decr = FALSE)
write_xlsx(rownames_to_column(as.data.frame(res_table), "gene_name"),
           path = "20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_down.xlsx")
include_graphics("20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_down.pdf")
```
[download Excel Table](20210328_LRT_HDACko_HDACreintroduction_e100_report/ci_deregulated_with_inh/HDAC1_KOci_vs_KO_down.xlsx)
